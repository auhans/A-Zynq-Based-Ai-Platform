...
/* Definitions for driver MM_VMX */
#define XPAR_MM_VMX_NUM_INSTANCES 1

/* Definitions for peripheral MM_VMX_0 */
#define XPAR_MM_VMX_0_DEVICE_ID 0
#define XPAR_MM_VMX_0_S_AXI_BASEADDR 0x43C00000
#define XPAR_MM_VMX_0_S_AXI_HIGHADDR 0x43C0FFFF
