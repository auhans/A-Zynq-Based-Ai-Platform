...
################################################################
# This is a generated script based on design: mm_design
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: myVMX, and set properties
  set myVMX [ create_bd_cell -type ip -vlnv xilinx.com:user:mmVMX:1.0 myVMX ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins AXI_INTER/S00_AXI] [get_bd_intf_pins PS/M_AXI_GP0]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXI_INTER/M00_AXI] [get_bd_intf_pins myVMX/S0_MMCTRL]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_INTER/ACLK] [get_bd_pins AXI_INTER/M00_ACLK] [get_bd_pins AXI_INTER/S00_ACLK] [get_bd_pins PS/FCLK_CLK0] [get_bd_pins PS/M_AXI_GP0_ACLK] [get_bd_pins PS_RST/slowest_sync_clk] [get_bd_pins myVMX/s0_mmctrl_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins PS/FCLK_RESET0_N] [get_bd_pins PS_RST/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_INTER/ARESETN] [get_bd_pins AXI_INTER/M00_ARESETN] [get_bd_pins AXI_INTER/S00_ARESETN] [get_bd_pins PS_RST/peripheral_aresetn] [get_bd_pins myVMX/s0_mmctrl_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00000100 -target_address_space [get_bd_addr_spaces PS/Data] [get_bd_addr_segs myVMX/S0_MMCTRL/S0_MMCTRL_reg] -force
